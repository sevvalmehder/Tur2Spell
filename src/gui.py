...
def main_graph(canvas, current_state):
    ...
    if current_state == 'reject':
        create_ovalq1(canvas, 'reject', x0 + 530, y0 + 150 + 30, x0 + 530 + 40, y0 + 150 + 30 + 40,
                      color="MediumPurple1", width=10, ocolor="gold")
    ...
    # q3
    if current_state == 'q3':
        create_ovalq1(canvas, 'q3', x0 + 100, y0 + 70, x0 + 100 + 40, y0 + 70 + 40, color="red", width=10,
                      ocolor="gold")
    else:
